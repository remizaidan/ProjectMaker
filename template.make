...
#### Specify here type of outputs: shared, static or exec
all : exec 
	@echo "All OK"
####
...
doxygen : 
	...
	@sed -i "/^FILE_PATTERNS /c\FILE_PATTERNS = *.h *.cxx *.md" $(DOXYCFG)
	...
	doxygen $(DOXYCFG)
	@cp -r $(DOCFIGURESDIR) $(DOXYDIR)/html/figures
